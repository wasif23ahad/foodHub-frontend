      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative group overflow-hidden rounded-[2.5rem] bg-slate-900 p-8 md:p-12 text-white h-[400px] flex flex-col justify-end shadow-2xl"
          >
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/70 mb-8 max-w-sm font-medium">
                Reach more customers and grow your business with our AI-powered delivery platform.
              </p>
              <Link href="/register?role=PROVIDER">
                <Button size="lg" className="bg-white text-primary hover:bg-slate-100 rounded-full px-8 h-14 font-bold group">
                  Join as a Seller
                  <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
                </Button>
              </Link>
